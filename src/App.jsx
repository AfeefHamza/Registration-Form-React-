    ...
    return (
        <div className="container  mt-5">
            <form className="bg-gradient-custom p-4 rounded shadow" onSubmit={handleSubmit}>
                <h2 className="mb-4 text-center">USER REGISTRATION FORM</h2>

                <div className="mb-3">
                    <label htmlFor="username" className="form-label">USERNAME :</label>
                    <input id="username" name="username" placeholder="Username please" type="text" className="form-control" value={formData.username} onChange={handleChange} />
                </div>
                ...
                <div className="mb-3">
                    ...
                    <div className="form-check">
                        ...
                        <label htmlFor="gaming" className="form-check-label">Gaming</label>
                    </div>
                    <div className="form-check">
                    ...
                    <div className="form-check">
                        ...
                        <label htmlFor="cooking" className="form-check-label">Cooking</label>
                    </div>
                </div>
